import os
from rfe import rfe_processing
from collections import defaultdict

# Base directory containing the subdirectories
base_directory = '/Users/brianmewhinney/dev/external/tradewinds-data/input/8'
...
for subdir, _, _ in os.walk(base_directory):
    ...
    if os.path.isfile(x_file) and os.path.isfile(y_file):
        ...
        cnt = cnt + 1
        results, selected_features = rfe_processing(x_file, y_file)
    else:
